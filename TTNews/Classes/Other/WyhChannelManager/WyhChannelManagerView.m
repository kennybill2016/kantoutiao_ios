...
-(void)initializeSubView{
    ...
    //可在此自定义
    self.editBtn.frame = CGRectMake(self.topTipView.bounds.size.width -2*edgeX-2*self.manager.style.padding-10, 0, 30, topY);
...
-(UIButton *)editBtn{
    ...
    if (!_editBtn) {
        ...
        [_editBtn.titleLabel setTextAlignment:NSTextAlignmentRight];
